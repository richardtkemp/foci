...
func TestSubagentRollingButton(t *testing.T) {
	...
	be.DeliverSubagentText("toolu_abc", "first", 1)
	if mock.sends != 1 {
	...
	be.DeliverSubagentText("toolu_abc", "second", 1)
	if mock.sends != 2 {
...
func TestSubagentHideDeletesAndSuppresses(t *testing.T) {
	...
	be.DeliverSubagentText("toolu_xyz", "one", 1)
	be.DeliverSubagentText("toolu_xyz", "two", 1)
	if mock.sends != 2 {
	...
	be.DeliverSubagentText("toolu_xyz", "three", 1)
	if mock.sends != 2 {
...
func TestSubagentSeparateGroups(t *testing.T) {
	...
	be.DeliverSubagentText("toolu_A", "a1", 1)
	be.DeliverSubagentText("toolu_B", "b1", 1)
