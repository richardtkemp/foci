...
func TestHandleMessageWithAttachments(t *testing.T) {
	...
	resp, err := ag.hmTestAttachments(context.Background(), "test/iimg", []string{"What is this?"}, images)
	if err != nil {
...
func TestHandleMessageWithPDFAttachment(t *testing.T) {
	...
	resp, err := ag.hmTestAttachments(context.Background(), "test/ipdf", []string{"Read this PDF"}, attachments)
	if err != nil {
		t.Fatalf("HandleMessageWithAttachments: %v", err)
	}
...
func TestHandleMessageWithPDFSavedPath(t *testing.T) {
	...
	_, err := ag.hmTestAttachments(context.Background(), "test/ipdfsaved", []string{"Check this"}, attachments)
	if err != nil {
		t.Fatalf("HandleMessageWithAttachments: %v", err)
	}
...
func TestHandleMessageWithAttachmentsNoText(t *testing.T) {
	...
	resp, err := ag.hmTestAttachments(context.Background(), "test/iimgonly", []string{""}, images)
	if err != nil {
		t.Fatalf("HandleMessageWithAttachments: %v", err)
	}
...
func TestHandleMessageDelegatesToWithImages(t *testing.T) {
	...
	ag.hmTest(context.Background(), "test/idelegate", "Hello")
...
func TestHandleMessageWithAttachmentsSavedPath(t *testing.T) {
	...
	resp, err := ag.hmTestAttachments(context.Background(), "test/isavepath", []string{"What is this?"}, images)
	if err != nil {
		t.Fatalf("HandleMessageWithAttachments: %v", err)
	}
	if resp != "Got it!" {
...
func TestHandleMessageWithAttachmentsNoSavedPath(t *testing.T) {
	...
	ag.hmTestAttachments(context.Background(), "test/inosaved", []string{"Look"}, images)
