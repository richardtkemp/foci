...
// platform package, instantiated for Discord bots. See platform/botpool.go
...
// NewBotManager creates an empty Discord BotManager.
func NewBotManager() *BotManager {
	return platform.NewBotManager[*Bot]("discord")
}
