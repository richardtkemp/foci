...
// DISABLED(opencode): ccstream's re-arm/shadow-turn machinery — opencode has no mid-turn queue; steers buffer-and-flush instead; see plan section 6.
// TestSteerFold_KeepsTurnInFlight_UntilShadowReply proves the invariant ...
// (original doc comment preserved inline)
//
...
// DISABLED(opencode): ccstream's re-arm/shadow-turn machinery — opencode has no mid-turn queue; steers buffer-and-flush instead; see plan section 6.
// TestSteerFold_WatchdogReleasesWhenNoShadowReply is the safety net ...
//
...
// DISABLED(opencode): ccstream's re-arm/shadow-turn machinery — opencode has no mid-turn queue; steers buffer-and-flush instead; see plan section 6.
// TestSteerFold_WatchdogDefersWhileOutstandingPrompt proves the watchdog ...
//
...
// DISABLED(opencode): ccstream's re-arm/shadow-turn machinery — opencode has no mid-turn queue; steers buffer-and-flush instead; see plan section 6.
// TestSteerFold_WatchdogDefersWhileActive proves the watchdog ...
//
