...
// DISABLED(opencode): ccstream permission dispatch/wire (control_request/control_response, PermissionRequest); opencode uses permission.updated SSE — see plan section 9.2
