...
var configFields = []ConfigField{
	...
	{"agent", "nudge_default_enable", FieldBool, "enable built-in tool/skill reminders"},
	{"agent", "nudge_default_frequency", FieldInt, "turns between tool/skill reminders (default 50)"},
	{"agent", "nudge_default_scratchpad_frequency", FieldInt, "turns between scratchpad review reminders (0=disabled, default 20)"},
	{"agent", "inject_agent_warnings", FieldString, "inject warnings into agent session: all, errors, off"},
	{"agent", "inject_chat_warnings", FieldString, "send warnings as chat notifications: all, errors, off"},
