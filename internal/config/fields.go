...
var configFields = []ConfigField{
	...
	{"defaults", "nudge_default_frequency", FieldInt, "turns between tool/skill reminders (default 25)"},
	...
	{"agent", "nudge_default_frequency", FieldInt, "turns between tool/skill reminders (default 25)"},
