...
var fieldConstraints = map[string]Constraint{
	...
	"agent.defaults.display.show_tool_calls":    {Choices: []string{"off", "preview", "full"}},
	"agent.defaults.display.show_thinking":      {Choices: []string{"off", "compact", "true"}},
...
var configFields = []ConfigField{
	...
	{"defaults", "loop.max_output_tokens", FieldInt, "max tokens in model response"},
	{"defaults", "loop.max_tool_loops", FieldInt, "max tool iterations per turn"},
	{"defaults", "loop.duplicate_messages", FieldBool, "send user text twice per API call"},
	{"defaults", "notify.inject_agent_warnings", FieldString, "inject warnings into agent session: all, errors, off"},
	{"defaults", "notify.inject_chat_warnings", FieldString, "send warnings as chat notifications: all, errors, off"},
	{"defaults", "notify.startup_notify", FieldBool, "send notification on startup"},
	{"defaults", "notify.compaction_notify", FieldBool, "send notification on compaction"},
	{"defaults", "notify.task_list_notify", FieldBool, "send notification on task list changes"},
	{"defaults", "notify.compaction_debug", FieldBool, "send compaction summary as file attachment"},
	...
	{"defaults", "behavior.steer_mode", FieldBool, "inject user messages between tool calls"},
	...
	{"defaults", "nudge.nudge_default_braindead_threshold", FieldInt, "consecutive tool loops before warning (0=disabled)"},
	{"defaults", "nudge.nudge_enable", FieldBool, "enable mid-turn behavioral reminders"},
	{"defaults", "nudge.nudge_auto_extract", FieldBool, "auto-extract rules from character files via LLM"},
	{"defaults", "nudge.nudge_cooldown", FieldInt, "min tool calls between repeating same reminder"},
	{"defaults", "nudge.nudge_max_per_batch", FieldInt, "max reminders injected per tool batch"},
	{"defaults", "nudge.nudge_pre_answer_gate", FieldBool, "enable pre-answer verification gate"},
	{"defaults", "nudge.nudge_pre_answer_min_tools", FieldInt, "min tool calls before pre-answer gate fires"},
	{"defaults", "nudge.nudge_default_enable", FieldBool, "enable built-in tool/skill reminders"},
	{"defaults", "nudge.nudge_default_frequency", FieldInt, "turns between tool/skill reminders (default 50)"},
	{"defaults", "nudge.nudge_default_scratchpad_frequency", FieldInt, "turns between scratchpad review reminders (0=disabled, default 20)"},
	...
	{"agent", "defaults.loop.max_tool_loops", FieldInt, "max tool iterations per turn"},
	{"agent", "defaults.loop.max_output_tokens", FieldInt, "max tokens in model response"},
	{"agent", "defaults.loop.duplicate_messages", FieldBool, "send user text twice per API call"},
	{"agent", "defaults.behavior.steer_mode", FieldBool, "inject user messages between tool calls"},
	{"agent", "defaults.nudge.nudge_enable", FieldBool, "enable mid-turn behavioral reminders"},
	{"agent", "defaults.nudge.nudge_auto_extract", FieldBool, "auto-extract rules from character files via LLM"},
	{"agent", "defaults.nudge.nudge_cooldown", FieldInt, "min tool calls between repeating same reminder"},
	{"agent", "defaults.nudge.nudge_max_per_batch", FieldInt, "max reminders injected per tool batch"},
	{"agent", "defaults.nudge.nudge_pre_answer_gate", FieldBool, "enable pre-answer verification gate"},
	{"agent", "defaults.nudge.nudge_pre_answer_min_tools", FieldInt, "min tool calls before pre-answer gate fires"},
	{"agent", "defaults.nudge.nudge_default_enable", FieldBool, "enable built-in tool/skill reminders"},
	{"agent", "defaults.nudge.nudge_default_frequency", FieldInt, "turns between tool/skill reminders (default 50)"},
	{"agent", "defaults.nudge.nudge_default_scratchpad_frequency", FieldInt, "turns between scratchpad review reminders (0=disabled, default 20)"},
	{"agent", "defaults.notify.inject_agent_warnings", FieldString, "inject warnings into agent session: all, errors, off"},
	{"agent", "defaults.notify.inject_chat_warnings", FieldString, "send warnings as chat notifications: all, errors, off"},
	{"agent", "defaults.display.show_tool_calls", FieldString, "tool call display: off, preview, full"},
	{"agent", "defaults.display.show_thinking", FieldString, "thinking display: off, compact, true"},
	...
	{"agent", "defaults.voice.tts", FieldString, "TTS provider id"},
	{"agent", "defaults.voice.stt", FieldString, "STT provider id"},
	{"agent", "defaults.voice.tts_rate", FieldFloat, "TTS speech rate multiplier"},
	...
	{"defaults", "behavior.enable_stop_aliases", FieldBool, "enable stop command aliases"},
