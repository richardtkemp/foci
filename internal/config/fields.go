...
var configFields = []ConfigField{
	...
	{"agent", "loop.max_tool_loops", FieldInt, "max tool iterations per turn"},
	{"agent", "loop.max_output_tokens", FieldInt, "max tokens in model response"},
	{"agent", "loop.duplicate_messages", FieldBool, "send user text twice per API call"},
	...
	{"agent", "notify.inject_agent_warnings", FieldString, "inject warnings into agent session: all, errors, off"},
	{"agent", "notify.inject_chat_warnings", FieldString, "send warnings as chat notifications: all, errors, off"},
