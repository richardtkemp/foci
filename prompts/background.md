...
- If the result is a change (cleanup, config, code) — just do it. No message needed unless it's interesting.
...
- If no suitable task exists, end immediately. Don't invent work.
