...
| `compaction_system_prompt` | string | `""` | Extra system prompt appended only during compaction API calls. Use this for compaction-specific instructions that don't need to be in every regular turn. |
