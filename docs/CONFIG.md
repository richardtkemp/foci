...
| `compaction_system_prompt` | string | `""` | Extra system prompt appended only during compaction API calls. Move compaction instructions here (instead of workspace files) to save ~1500 tokens on every regular turn. |
