...
- `SystemPrompt` — extra system prompt appended only during the compaction API call (not on regular turns). Move compaction instructions here to save ~1500 tokens per regular API call.
