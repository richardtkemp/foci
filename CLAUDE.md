...
- **Config-breaking commits.** If a change requires users to update their `foci.toml`, the commit message must include an example of the old form and the new form. For example:
	```
